...
bin_PROGRAMS = cjpeg$(EXEEXT) djpeg$(EXEEXT) jpegtran$(EXEEXT) \
	rdjpgcom$(EXEEXT) wrjpgcom$(EXEEXT) mtest$(EXEEXT)
subdir = .
...
am_cjpeg_OBJECTS = cjpeg.$(OBJEXT) rdppm.$(OBJEXT) rdgif.$(OBJEXT) \
	...
	rdswitch.$(OBJEXT) cdjpeg.$(OBJEXT) majapeg.$(OBJEXT) \
	adaptf.$(OBJEXT)
...
am__depfiles_remade = ./$(DEPDIR)/jmemnobs.Plo \
	./$(DEPDIR)/adaptf.Po ./$(DEPDIR)/cdjpeg.Po \
	./$(DEPDIR)/cjpeg.Po ./$(DEPDIR)/djpeg.Po \
	./$(DEPDIR)/jaricom.Plo ./$(DEPDIR)/jcapimin.Plo \
	./$(DEPDIR)/jcapistd.Plo ./$(DEPDIR)/jcarith.Plo \
	./$(DEPDIR)/jccoefct.Plo ./$(DEPDIR)/jccolor.Plo \
	./$(DEPDIR)/jcdctmgr.Plo ./$(DEPDIR)/jchuff.Plo \
	./$(DEPDIR)/jcinit.Plo ./$(DEPDIR)/jcmainct.Plo \
	./$(DEPDIR)/jcmarker.Plo ./$(DEPDIR)/jcmaster.Plo \
	./$(DEPDIR)/jcomapi.Plo ./$(DEPDIR)/jcparam.Plo \
	./$(DEPDIR)/jcprepct.Plo ./$(DEPDIR)/jcsample.Plo \
	...
	./$(DEPDIR)/jdmerge.Plo ./$(DEPDIR)/jdpostct.Plo \
	./$(DEPDIR)/jdsample.Plo ./$(DEPDIR)/jdtrans.Plo \
	./$(DEPDIR)/jerror.Plo ./$(DEPDIR)/jfdctflt.Plo \
	./$(DEPDIR)/jfdctfst.Plo ./$(DEPDIR)/jfdctint.Plo \
	./$(DEPDIR)/jidctflt.Plo ./$(DEPDIR)/jidctfst.Plo \
	./$(DEPDIR)/jidctint.Plo ./$(DEPDIR)/jmemmgr.Plo \
	./$(DEPDIR)/jpegtran.Po ./$(DEPDIR)/jquant1.Plo \
	./$(DEPDIR)/jquant2.Plo ./$(DEPDIR)/jutils.Plo \
	./$(DEPDIR)/majapeg.Po ./$(DEPDIR)/rdbmp.Po \
	./$(DEPDIR)/rdcolmap.Po ./$(DEPDIR)/rdgif.Po \
	./$(DEPDIR)/rdjpgcom.Po ./$(DEPDIR)/rdppm.Po \
	./$(DEPDIR)/rdrle.Po ./$(DEPDIR)/rdswitch.Po \
	./$(DEPDIR)/rdtarga.Po ./$(DEPDIR)/test.Po \
	./$(DEPDIR)/transupp.Po ./$(DEPDIR)/wrbmp.Po \
	./$(DEPDIR)/wrgif.Po ./$(DEPDIR)/wrjpgcom.Po \
	./$(DEPDIR)/wrppm.Po ./$(DEPDIR)/wrrle.Po \
	./$(DEPDIR)/wrtarga.Po
am__mv = mv -f
...
SOURCES = $(libjpeg_la_SOURCES) $(cjpeg_SOURCES) $(djpeg_SOURCES) \
	$(jpegtran_SOURCES) $(mtest_SOURCES) $(rdjpgcom_SOURCES) \
	$(wrjpgcom_SOURCES)
...
ACLOCAL = ${SHELL} '/mnt/d/Maja/petnica/polaznik/rac 2-2/adapt-jpeg/adapt.jpeg/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AS = as
AUTOCONF = ${SHELL} '/mnt/d/Maja/petnica/polaznik/rac 2-2/adapt-jpeg/adapt.jpeg/missing' autoconf
AUTOHEADER = echo autoheader ignored
AUTOMAKE = ${SHELL} '/mnt/d/Maja/petnica/polaznik/rac 2-2/adapt-jpeg/adapt.jpeg/missing' automake-1.16
AWK = gawk
CC = gcc
...
JPEG_LIB_VERSION = 14:0:5
JPEG_LIB_VERSION_MAJOR = 9
JPEG_LIB_VERSION_MINOR = 5
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} '/mnt/d/Maja/petnica/polaznik/rac 2-2/adapt-jpeg/adapt.jpeg/missing' makeinfo
MANIFEST_TOOL = :
MEMORYMGR = jmemnobs
...
STRIP = strip
VERSION = 9.5.0
abs_builddir = /mnt/d/Maja/petnica/polaznik/rac 2-2/adapt-jpeg/adapt.jpeg
abs_srcdir = /mnt/d/Maja/petnica/polaznik/rac 2-2/adapt-jpeg/adapt.jpeg
abs_top_builddir = /mnt/d/Maja/petnica/polaznik/rac 2-2/adapt-jpeg/adapt.jpeg
abs_top_srcdir = /mnt/d/Maja/petnica/polaznik/rac 2-2/adapt-jpeg/adapt.jpeg
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} '/mnt/d/Maja/petnica/polaznik/rac 2-2/adapt-jpeg/adapt.jpeg/install-sh'
...
mtest_SOURCES = test.cpp
cjpeg_SOURCES = cjpeg.c rdppm.c rdgif.c rdtarga.c rdrle.c rdbmp.c \
        rdswitch.c cdjpeg.c majapeg.cpp adaptf.c
...
#jcdctmgr_SOURCES  = adaptf.c
#jcdctmgr_LDADD  = libjpeg.la
...
cjpeg$(EXEEXT): $(cjpeg_OBJECTS) $(cjpeg_DEPENDENCIES) $(EXTRA_cjpeg_DEPENDENCIES) 
	@rm -f cjpeg$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(cjpeg_OBJECTS) $(cjpeg_LDADD) $(LIBS)
...
mtest$(EXEEXT): $(mtest_OBJECTS) $(mtest_DEPENDENCIES) $(EXTRA_mtest_DEPENDENCIES) 
	@rm -f mtest$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(mtest_OBJECTS) $(mtest_LDADD) $(LIBS)
...
include ./$(DEPDIR)/adaptf.Po # am--include-marker
...
include ./$(DEPDIR)/majapeg.Po # am--include-marker
